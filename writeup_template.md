...
[image1]: PilotNet_NVIDIA.JPG "PilotNet from NVIDIA"
...
1. A Keras lambda layer (model.py, code line 66) to normalize the data. 
2. A filter of 5x5 size and 24 depth, with stride of 2x2, followed by a RELU activation function (model.py, code line 67). 
